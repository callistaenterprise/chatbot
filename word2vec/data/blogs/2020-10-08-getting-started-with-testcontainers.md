...
layout: details-blog
published: true
heading: Getting started with Testcontainers
authors: 
  - petermerikan
...
![Test Pyramide](/assets/blogg/getting-started-with-testcontainers/test-pyramide.png)
{: refdef}
...
{:refdef: style="text-align: center;"}
![modules](/assets/blogg/getting-started-with-testcontainers/modules.png)
{: refdef}
